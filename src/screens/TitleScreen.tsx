...
export function TitleScreen({ bestScore, onStart }: TitleScreenProps) {
  ...
  return (
    <View testID="title-screen" style={styles.root} accessibilityViewIsModal>
      <View style={styles.card}>
        ...
        {/* Settings stays hidden until its T05 service is implemented. */}
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  root: { ...StyleSheet.absoluteFill, justifyContent: 'center', alignItems: 'flex-end', padding: 24, zIndex: 4 },
  card: { width: '100%', maxWidth: 352, backgroundColor: palette.paper, padding: 24, borderRadius: 28, borderWidth: 1, borderColor: palette.border },
  accent: { width: 34, height: 6, borderRadius: 3, backgroundColor: palette.lavender, marginBottom: 15 },
  ...
  record: { marginTop: 22, marginBottom: 19, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 14, backgroundColor: palette.background },
